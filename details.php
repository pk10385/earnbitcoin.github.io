...
<div class="post_cat5">
    ...
    <div class='cat_bg5'>DETAILS</div>
    <?php
    $id = $_GET['pro'];

$que = "SELECT * from hl_listings where id=$id  and status=1  " ;
...
<div class="frm-title5">
<div class="title1">
        <div class="title_left"> <a href="open.php?link=<?php echo $id; ?>" target="_blank"><?php echo $name; ?></a></div>
        <div class="title_right">
     <ul>
        <li><a href="details.php?pro=<?php echo $id; ?>">Details</a></li>
        <li><a href="image.php?img=<?php echo $id; ?>" target="_blank">Monitor Button</a></li>
...
<div class="col2">
  ...
  <div class="others">Payment Processors:</div>
    <div class="paysystems"><?php echo "
                   ".(($msp == 1) ? '
                            <img src="templates/images/getways/0.png" width="20" height="20" title="MySidePay">' : '')
                   .(($pm == 1) ? '
...
<hr>
<img src="/image.php?img=<?php echo $id; ?>">
        <textarea cols="30" rows="6">
        <a href="/details.php?pro=<?php echo $id; ?>"><img src="<?php echo $site_url; ?>image.php?img=<?php echo $id;?>" border="0"></a> 
        </textarea>
