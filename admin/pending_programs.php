...
<?php
    ...
    echo " <div class='cat_bg2'>ALL PENDING PROGRAMS</div>";
  

$que = "SELECT * from hl_listings where status=0   " ;
...
<div class="title_right">
          ...
          <form action="activate_order.php?pro=<?php echo $id; ?>" method="post">
     ...
     <br>
         ...
         <form action="delete_order.php?pro=<?php echo $id; ?>" method="post">
...
$q1= "delete from hl_listings where status=0 ";
 ...
 if($run1){
   ...
   echo "<script>alert('Order deleted successful!')</script>";
	  }
	 else {
