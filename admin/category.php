...
<div class="post_cat2">
    <div class="cat_bg2"> CATEGORIES</div>
...
<p> EDIT LISTING CATEGORY NAME AND PRICE </p>
				<table class="serv-table">
<tr>
 <td class="none">CATEGORY NAME</td>
...
while ($get = mysqli_fetch_array($run))
{
    ...
    echo "<tr>
 <td><div class='name'>$cat_name</div></td>
 <td>$cat_price $</td>
 
 
 <td><a href='edit_cat.php?cat=$cat_id' class='ad-btn2'>EDIT</a></td>
