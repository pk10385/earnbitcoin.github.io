...
if (isset($_POST['submit'])){
     ...
     $edit_date = date('d-F-Y');
$q="insert into hl_statistics (listing_id,date,amount,comment,name,url,simple_date) values ('$pro_id','$date','$amount','$details','$name','$url','$simple_date')";
$run = mysqli_query($con,$q);



$q1= "update hl_listings set last_payout='$edit_date' where id=$id ";
...
?>
<div class="cat_bg2"> Add Payout Transaction details</div>
    

     <form action="payouts.php?pro=<?php echo $get_id = $_GET['pro']?>" method="post">
        ...
        <table >
         ...
         <tr>
          <td>Description: </td>
          <td><textarea type="text" name="details" cols="30" rows="5"></textarea>  </td>
         </tr >
