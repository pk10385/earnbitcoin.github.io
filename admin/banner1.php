...
<p style="color:red; font-weight:bolder; font-size:14px;text-align:center;">Add only one banner space in static category if you already have one then dont add more or delete old for add more</p>

        
       	

    <a href="new_banner.php?type=1" class="cat_bg2" style="color:white;"> ADD NEW BANNER SPACE</a>
    <br><br>
</div>
