...
$q= "update hl_listings set our_investment='$amount' where id=$id ";
...
?>
<div class="cat_bg2"> Add Transaction for show in our investment</div>
    

     <form action="our_investment.php?pro=<?php echo $get_id = $_GET['pro']?>" method="post">
